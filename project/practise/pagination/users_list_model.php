...
class Users_list_model extends MY_Generic_Model
{
   ...
   public function get_user_image($id)
   {
	...
	public function get_user_list()
	{
		...
		$fields ="id,user_name, first_name, last_name, email,status, DATE_FORMAT(created_date, '%d %M,%Y %h:%i %p') as date";
		...
		$this->model_pagination->set_per_page(5);
		$this->model_pagination->set_uri_segment("4");
		return  $this->model_pagination->query_pagination(base_url()."admin/users/all/", $fields, $table_name, $other);
	}
