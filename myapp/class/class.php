<?php
	...
	class Database
	{
		...
		*/
		public function doUpdate($myquery)
		{
			return mysql_query($myquery) or die(mysql_error());			
		}
		...
		** @return MySql resource
		*/
		public function doDelete($myquery)
		{
			return mysql_query($myquery) or die(mysql_error());			
		}
	...
	class MyApp extends Database
	{
		...
		{
			return $this->doMultipleQuery("SELECT  id, title,description from `pages` WHERE title LIKE '%".$this->search_keyword."%' OR description LIKE '%".$this->search_keyword."%'");			
		}
		...
		public function store()
		{
			...
			if(!$result)
			{
				exit("Failed to add new page, please try again.");
			}
		}
	}
