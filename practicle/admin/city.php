...
<div class="menu">
    ...
    <form id="form" name="form" action="city.php" enctype="multipart/form-data" method="post">
     ...
     <div class="clear sep"></div>
		 ...
		 <div class="inp-con"><select name="state">
		<option>Select</option>
		

        <?php
		 $sql = "select id,state_name from csc";
		 $result = mysql_query($sql);
					if($result)
					{
						while($rows = mysql_fetch_array($result,MYSQL_ASSOC))
...
<div class="lable">City :</div>
		<div class="inp-con"><input type="text" name="city" id="city" placeholder="<--add city-->"></div>
		<div class="clear sep"></div>
