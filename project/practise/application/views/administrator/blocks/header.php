...
<div id="top-panel">
      <div id="panel">
	      ...
	      <li><a href="<?php echo base_url('administrator/country/add_country'); ?>" title="Country" class="manage">Country</a></li>
	      <li><a href="<?php echo base_url('administrator/state/add_state'); ?>" title="State" class="manage">State</a></li>
	      <li><a href="<?php echo base_url('administrator/city/add_city'); ?>" title="City" class="manage">City</a></li>
	      <li><a href="<?php echo base_url('administrator/conversation/admin_conversation'); ?>" title="Conversation" class="manage">Conversation</a></li>
