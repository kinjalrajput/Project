...
jQuery.noConflict();
var vFormatCopyButtons="";

/* Set the defaults for DataTables initialisation */
jQuery.extend( true, jQuery.fn.dataTable.defaults, {
	"sDom": "<\'row-fluid\'<\'span6\'f>" + vFormatCopyButtons +
"r>t<\'row-fluid\'<\'span4\'l><\'span4 text-center\'i><\'span4\'p>r>",
...
jQuery.extend( jQuery.fn.dataTableExt.oPagination, {
	"bootstrap": {
		"fnInit": function( oSettings, nPaging, fnDraw ) {
			...
			jQuery(nPaging).addClass('pagination pagination-right').append(
				'<ul class="pagination">'+
